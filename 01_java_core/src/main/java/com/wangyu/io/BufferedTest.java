...
//        bufferedTest.testCopyFileWithBuffered();
        bufferedTest.test4();
    }
    ...
    public void BufferedStreamTest(){
        ...
        try {
            ...
            File destFile = new File("01_java_core/3.jpg");
            //2.造流
            //2.1 造节点流
...
//        fis.close();
    ...
    public void testCopyFileWithBuffered(){
        ...
        System.out.println("复制操作花费的时间为：" + (end - start) + "ms"); // 1091ms
    }
    ...
    public void test4(){
        ...
        try {
            //创建文件和相应的流
            br = new BufferedReader(new FileReader(new File("01_java_core/hello.txt")));
